...
Revision ID: b91e47899608
Revises: 
Create Date: 2025-03-20 14:16:20.658885
...
def upgrade() -> None:
    ...
    sa.Column('role', sa.Enum('MANAGER', 'ADMIN', 'SUPERADMIN', name='employeeroleenum'), nullable=False),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'CANCELED', 'COMPLETED', name='reservationstatusenum'), nullable=False),
    ...
    sa.Column('status', sa.Enum('PENDING', 'CONFIRMED', 'CANCELED', 'COMPLETED', name='orderstatusenum'), nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('updated_at', sa.DateTime(), nullable=True),
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('reservation_id', sa.Integer(), nullable=False),
    sa.Column('previous_status', sa.Enum('PENDING', 'CONFIRMED', 'CANCELED', 'COMPLETED', name='reservationstatusenum'), nullable=True),
    sa.Column('new_status', sa.Enum('PENDING', 'CONFIRMED', 'CANCELED', 'COMPLETED', name='reservationstatusenum'), nullable=False),
